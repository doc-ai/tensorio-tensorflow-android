...
#ifndef GOOGLE_PROTOBUF_INCLUDED_tensorflow_2fcontrib_2fboosted_5ftrees_2fproto_2flearner_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_tensorflow_2fcontrib_2fboosted_5ftrees_2fproto_2flearner_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_tensorflow_2fcontrib_2fboosted_5ftrees_2fproto_2flearner_2eproto
...
struct TableStruct_tensorflow_2fcontrib_2fboosted_5ftrees_2fproto_2flearner_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensorflow_2fcontrib_2fboosted_5ftrees_2fproto_2flearner_2eproto;
...
enum LearnerConfig_PruningMode : int {
  ...
  LearnerConfig_PruningMode_LearnerConfig_PruningMode_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  LearnerConfig_PruningMode_LearnerConfig_PruningMode_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool LearnerConfig_PruningMode_IsValid(int value);
constexpr LearnerConfig_PruningMode LearnerConfig_PruningMode_PruningMode_MIN = LearnerConfig_PruningMode_PRUNING_MODE_UNSPECIFIED;
constexpr LearnerConfig_PruningMode LearnerConfig_PruningMode_PruningMode_MAX = LearnerConfig_PruningMode_POST_PRUNE;
constexpr int LearnerConfig_PruningMode_PruningMode_ARRAYSIZE = LearnerConfig_PruningMode_PruningMode_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* LearnerConfig_PruningMode_descriptor();
template<typename T>
inline const std::string& LearnerConfig_PruningMode_Name(T enum_t_value) {
  static_assert(::std::is_same<T, LearnerConfig_PruningMode>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function LearnerConfig_PruningMode_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    LearnerConfig_PruningMode_descriptor(), enum_t_value);
}
inline bool LearnerConfig_PruningMode_Parse(
    const std::string& name, LearnerConfig_PruningMode* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<LearnerConfig_PruningMode>(
    LearnerConfig_PruningMode_descriptor(), name, value);
}
enum LearnerConfig_GrowingMode : int {
  ...
  LearnerConfig_GrowingMode_LearnerConfig_GrowingMode_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  LearnerConfig_GrowingMode_LearnerConfig_GrowingMode_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool LearnerConfig_GrowingMode_IsValid(int value);
constexpr LearnerConfig_GrowingMode LearnerConfig_GrowingMode_GrowingMode_MIN = LearnerConfig_GrowingMode_GROWING_MODE_UNSPECIFIED;
constexpr LearnerConfig_GrowingMode LearnerConfig_GrowingMode_GrowingMode_MAX = LearnerConfig_GrowingMode_LAYER_BY_LAYER;
constexpr int LearnerConfig_GrowingMode_GrowingMode_ARRAYSIZE = LearnerConfig_GrowingMode_GrowingMode_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* LearnerConfig_GrowingMode_descriptor();
template<typename T>
inline const std::string& LearnerConfig_GrowingMode_Name(T enum_t_value) {
  static_assert(::std::is_same<T, LearnerConfig_GrowingMode>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function LearnerConfig_GrowingMode_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    LearnerConfig_GrowingMode_descriptor(), enum_t_value);
}
inline bool LearnerConfig_GrowingMode_Parse(
    const std::string& name, LearnerConfig_GrowingMode* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<LearnerConfig_GrowingMode>(
    LearnerConfig_GrowingMode_descriptor(), name, value);
}
enum LearnerConfig_MultiClassStrategy : int {
  ...
  LearnerConfig_MultiClassStrategy_LearnerConfig_MultiClassStrategy_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  LearnerConfig_MultiClassStrategy_LearnerConfig_MultiClassStrategy_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool LearnerConfig_MultiClassStrategy_IsValid(int value);
constexpr LearnerConfig_MultiClassStrategy LearnerConfig_MultiClassStrategy_MultiClassStrategy_MIN = LearnerConfig_MultiClassStrategy_MULTI_CLASS_STRATEGY_UNSPECIFIED;
constexpr LearnerConfig_MultiClassStrategy LearnerConfig_MultiClassStrategy_MultiClassStrategy_MAX = LearnerConfig_MultiClassStrategy_DIAGONAL_HESSIAN;
constexpr int LearnerConfig_MultiClassStrategy_MultiClassStrategy_ARRAYSIZE = LearnerConfig_MultiClassStrategy_MultiClassStrategy_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* LearnerConfig_MultiClassStrategy_descriptor();
template<typename T>
inline const std::string& LearnerConfig_MultiClassStrategy_Name(T enum_t_value) {
  static_assert(::std::is_same<T, LearnerConfig_MultiClassStrategy>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function LearnerConfig_MultiClassStrategy_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    LearnerConfig_MultiClassStrategy_descriptor(), enum_t_value);
}
inline bool LearnerConfig_MultiClassStrategy_Parse(
    const std::string& name, LearnerConfig_MultiClassStrategy* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<LearnerConfig_MultiClassStrategy>(
    LearnerConfig_MultiClassStrategy_descriptor(), name, value);
}
enum LearnerConfig_WeakLearnerType : int {
  LearnerConfig_WeakLearnerType_NORMAL_DECISION_TREE = 0,
  LearnerConfig_WeakLearnerType_OBLIVIOUS_DECISION_TREE = 1,
  LearnerConfig_WeakLearnerType_LearnerConfig_WeakLearnerType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  LearnerConfig_WeakLearnerType_LearnerConfig_WeakLearnerType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool LearnerConfig_WeakLearnerType_IsValid(int value);
constexpr LearnerConfig_WeakLearnerType LearnerConfig_WeakLearnerType_WeakLearnerType_MIN = LearnerConfig_WeakLearnerType_NORMAL_DECISION_TREE;
constexpr LearnerConfig_WeakLearnerType LearnerConfig_WeakLearnerType_WeakLearnerType_MAX = LearnerConfig_WeakLearnerType_OBLIVIOUS_DECISION_TREE;
constexpr int LearnerConfig_WeakLearnerType_WeakLearnerType_ARRAYSIZE = LearnerConfig_WeakLearnerType_WeakLearnerType_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* LearnerConfig_WeakLearnerType_descriptor();
template<typename T>
inline const std::string& LearnerConfig_WeakLearnerType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, LearnerConfig_WeakLearnerType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function LearnerConfig_WeakLearnerType_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    LearnerConfig_WeakLearnerType_descriptor(), enum_t_value);
}
inline bool LearnerConfig_WeakLearnerType_Parse(
    const std::string& name, LearnerConfig_WeakLearnerType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<LearnerConfig_WeakLearnerType>(
    LearnerConfig_WeakLearnerType_descriptor(), name, value);
}
// ===================================================================

class TreeRegularizationConfig :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorflow.boosted_trees.learner.TreeRegularizationConfig) */ {
 public:
  ...
  inline TreeRegularizationConfig* New() const final {
    return CreateMaybeMessage<TreeRegularizationConfig>(nullptr);
  }

  TreeRegularizationConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorflow.boosted_trees.learner.TreeRegularizationConfig";
  }
  protected:
  explicit TreeRegularizationConfig(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_tensorflow_2fcontrib_2fboosted_5ftrees_2fproto_2flearner_2eproto);
    return ::descriptor_table_tensorflow_2fcontrib_2fboosted_5ftrees_2fproto_2flearner_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  friend struct ::TableStruct_tensorflow_2fcontrib_2fboosted_5ftrees_2fproto_2flearner_2eproto;
};
// -------------------------------------------------------------------

class TreeConstraintsConfig :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorflow.boosted_trees.learner.TreeConstraintsConfig) */ {
 public:
  ...
  inline TreeConstraintsConfig* New() const final {
    return CreateMaybeMessage<TreeConstraintsConfig>(nullptr);
  }

  TreeConstraintsConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorflow.boosted_trees.learner.TreeConstraintsConfig";
  }
  protected:
  explicit TreeConstraintsConfig(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint32 max_tree_depth() const;
  void set_max_tree_depth(::PROTOBUF_NAMESPACE_ID::uint32 value);
  ...
  ::PROTOBUF_NAMESPACE_ID::int64 max_number_of_unique_feature_columns() const;
  void set_max_number_of_unique_feature_columns(::PROTOBUF_NAMESPACE_ID::int64 value);
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::uint32 max_tree_depth_;
  float min_node_weight_;
  ::PROTOBUF_NAMESPACE_ID::int64 max_number_of_unique_feature_columns_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_tensorflow_2fcontrib_2fboosted_5ftrees_2fproto_2flearner_2eproto;
};
// -------------------------------------------------------------------
...
class LearningRateConfig :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorflow.boosted_trees.learner.LearningRateConfig) */ {
 public:
  LearningRateConfig();
  ...
  inline LearningRateConfig* New() const final {
    return CreateMaybeMessage<LearningRateConfig>(nullptr);
  }

  LearningRateConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorflow.boosted_trees.learner.LearningRateConfig";
  }
  protected:
  explicit LearningRateConfig(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
...
class LearningRateFixedConfig :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorflow.boosted_trees.learner.LearningRateFixedConfig) */ {
 public:
  ...
  inline LearningRateFixedConfig* New() const final {
    return CreateMaybeMessage<LearningRateFixedConfig>(nullptr);
  }

  LearningRateFixedConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorflow.boosted_trees.learner.LearningRateFixedConfig";
  }
  protected:
  explicit LearningRateFixedConfig(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
...
class LearningRateLineSearchConfig :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorflow.boosted_trees.learner.LearningRateLineSearchConfig) */ {
 public:
  ...
  inline LearningRateLineSearchConfig* New() const final {
    return CreateMaybeMessage<LearningRateLineSearchConfig>(nullptr);
  }

  LearningRateLineSearchConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorflow.boosted_trees.learner.LearningRateLineSearchConfig";
  }
  protected:
  explicit LearningRateLineSearchConfig(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 num_steps() const;
  void set_num_steps(::PROTOBUF_NAMESPACE_ID::int32 value);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 num_steps_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_tensorflow_2fcontrib_2fboosted_5ftrees_2fproto_2flearner_2eproto;
};
// -------------------------------------------------------------------
...
class AveragingConfig :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorflow.boosted_trees.learner.AveragingConfig) */ {
 public:
  AveragingConfig();
  ...
  inline AveragingConfig* New() const final {
    return CreateMaybeMessage<AveragingConfig>(nullptr);
  }

  AveragingConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorflow.boosted_trees.learner.AveragingConfig";
  }
  protected:
  explicit AveragingConfig(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
...
class LearningRateDropoutDrivenConfig :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorflow.boosted_trees.learner.LearningRateDropoutDrivenConfig) */ {
 public:
  ...
  inline LearningRateDropoutDrivenConfig* New() const final {
    return CreateMaybeMessage<LearningRateDropoutDrivenConfig>(nullptr);
  }

  LearningRateDropoutDrivenConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorflow.boosted_trees.learner.LearningRateDropoutDrivenConfig";
  }
  protected:
  explicit LearningRateDropoutDrivenConfig(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
...
class LearnerConfig :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorflow.boosted_trees.learner.LearnerConfig) */ {
 public:
  LearnerConfig();
  ...
  inline LearnerConfig* New() const final {
    return CreateMaybeMessage<LearnerConfig>(nullptr);
  }

  LearnerConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorflow.boosted_trees.learner.LearnerConfig";
  }
  protected:
  explicit LearnerConfig(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  ...
  static constexpr PruningMode PRUNING_MODE_UNSPECIFIED =
    LearnerConfig_PruningMode_PRUNING_MODE_UNSPECIFIED;
  static constexpr PruningMode PRE_PRUNE =
    LearnerConfig_PruningMode_PRE_PRUNE;
  static constexpr PruningMode POST_PRUNE =
  ...
  static constexpr PruningMode PruningMode_MIN =
    LearnerConfig_PruningMode_PruningMode_MIN;
  static constexpr PruningMode PruningMode_MAX =
    LearnerConfig_PruningMode_PruningMode_MAX;
  static constexpr int PruningMode_ARRAYSIZE =
  ...
  template<typename T>
  static inline const std::string& PruningMode_Name(T enum_t_value) {
    static_assert(::std::is_same<T, PruningMode>::value ||
      ::std::is_integral<T>::value,
      "Incorrect type passed to function PruningMode_Name.");
    return LearnerConfig_PruningMode_Name(enum_t_value);
  }
  ...
  static constexpr GrowingMode GROWING_MODE_UNSPECIFIED =
    LearnerConfig_GrowingMode_GROWING_MODE_UNSPECIFIED;
  static constexpr GrowingMode WHOLE_TREE =
    LearnerConfig_GrowingMode_WHOLE_TREE;
  static constexpr GrowingMode LAYER_BY_LAYER =
  ...
  static constexpr GrowingMode GrowingMode_MIN =
    LearnerConfig_GrowingMode_GrowingMode_MIN;
  static constexpr GrowingMode GrowingMode_MAX =
    LearnerConfig_GrowingMode_GrowingMode_MAX;
  static constexpr int GrowingMode_ARRAYSIZE =
  ...
  template<typename T>
  static inline const std::string& GrowingMode_Name(T enum_t_value) {
    static_assert(::std::is_same<T, GrowingMode>::value ||
      ::std::is_integral<T>::value,
      "Incorrect type passed to function GrowingMode_Name.");
    return LearnerConfig_GrowingMode_Name(enum_t_value);
  }
  ...
  static constexpr MultiClassStrategy MULTI_CLASS_STRATEGY_UNSPECIFIED =
    LearnerConfig_MultiClassStrategy_MULTI_CLASS_STRATEGY_UNSPECIFIED;
  static constexpr MultiClassStrategy TREE_PER_CLASS =
    LearnerConfig_MultiClassStrategy_TREE_PER_CLASS;
  static constexpr MultiClassStrategy FULL_HESSIAN =
    LearnerConfig_MultiClassStrategy_FULL_HESSIAN;
  static constexpr MultiClassStrategy DIAGONAL_HESSIAN =
  ...
  static constexpr MultiClassStrategy MultiClassStrategy_MIN =
    LearnerConfig_MultiClassStrategy_MultiClassStrategy_MIN;
  static constexpr MultiClassStrategy MultiClassStrategy_MAX =
    LearnerConfig_MultiClassStrategy_MultiClassStrategy_MAX;
  static constexpr int MultiClassStrategy_ARRAYSIZE =
  ...
  template<typename T>
  static inline const std::string& MultiClassStrategy_Name(T enum_t_value) {
    static_assert(::std::is_same<T, MultiClassStrategy>::value ||
      ::std::is_integral<T>::value,
      "Incorrect type passed to function MultiClassStrategy_Name.");
    return LearnerConfig_MultiClassStrategy_Name(enum_t_value);
  }
  ...
  static constexpr WeakLearnerType NORMAL_DECISION_TREE =
    LearnerConfig_WeakLearnerType_NORMAL_DECISION_TREE;
  static constexpr WeakLearnerType OBLIVIOUS_DECISION_TREE =
  ...
  static constexpr WeakLearnerType WeakLearnerType_MIN =
    LearnerConfig_WeakLearnerType_WeakLearnerType_MIN;
  static constexpr WeakLearnerType WeakLearnerType_MAX =
    LearnerConfig_WeakLearnerType_WeakLearnerType_MAX;
  static constexpr int WeakLearnerType_ARRAYSIZE =
  ...
  template<typename T>
  static inline const std::string& WeakLearnerType_Name(T enum_t_value) {
    static_assert(::std::is_same<T, WeakLearnerType>::value ||
      ::std::is_integral<T>::value,
      "Incorrect type passed to function WeakLearnerType_Name.");
    return LearnerConfig_WeakLearnerType_Name(enum_t_value);
  }
  ...
  bool has_each_tree_start() const;
  void clear_each_tree_start();
  static const int kEachTreeStartFieldNumber = 13;
  const ::tensorflow::boosted_trees::trees::DecisionTreeConfig& each_tree_start() const;
  ::tensorflow::boosted_trees::trees::DecisionTreeConfig* release_each_tree_start();
  ::tensorflow::boosted_trees::trees::DecisionTreeConfig* mutable_each_tree_start();
  void set_allocated_each_tree_start(::tensorflow::boosted_trees::trees::DecisionTreeConfig* each_tree_start);
  void unsafe_arena_set_allocated_each_tree_start(
      ::tensorflow::boosted_trees::trees::DecisionTreeConfig* each_tree_start);
  ::tensorflow::boosted_trees::trees::DecisionTreeConfig* unsafe_arena_release_each_tree_start();
  ...
  void clear_each_tree_start_num_layers();
  static const int kEachTreeStartNumLayersFieldNumber = 14;
  ::PROTOBUF_NAMESPACE_ID::int32 each_tree_start_num_layers() const;
  void set_each_tree_start_num_layers(::PROTOBUF_NAMESPACE_ID::int32 value);
 ...
 private:
  ...
  ::tensorflow::boosted_trees::trees::DecisionTreeConfig* each_tree_start_;
  ::PROTOBUF_NAMESPACE_ID::uint32 num_classes_;
  int pruning_mode_;
  int growing_mode_;
  int multi_class_strategy_;
  int weak_learner_type_;
  ::PROTOBUF_NAMESPACE_ID::int32 each_tree_start_num_layers_;
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 TreeConstraintsConfig::max_tree_depth() const {
...
inline void TreeConstraintsConfig::set_max_tree_depth(::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
inline void TreeConstraintsConfig::clear_max_number_of_unique_feature_columns() {
  max_number_of_unique_feature_columns_ = PROTOBUF_LONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::int64 TreeConstraintsConfig::max_number_of_unique_feature_columns() const {
...
inline void TreeConstraintsConfig::set_max_number_of_unique_feature_columns(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 LearningRateLineSearchConfig::num_steps() const {
  // @@protoc_insertion_point(field_get:tensorflow.boosted_trees.learner.LearningRateLineSearchConfig.num_steps)
  return num_steps_;
}
inline void LearningRateLineSearchConfig::set_num_steps(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 LearnerConfig::num_classes() const {
  // @@protoc_insertion_point(field_get:tensorflow.boosted_trees.learner.LearnerConfig.num_classes)
  return num_classes_;
}
inline void LearnerConfig::set_num_classes(::PROTOBUF_NAMESPACE_ID::uint32 value) {
...
inline bool LearnerConfig::has_regularization() const {
  return this != internal_default_instance() && regularization_ != nullptr;
}
inline void LearnerConfig::clear_regularization() {
  if (GetArenaNoVirtual() == nullptr && regularization_ != nullptr) {
    delete regularization_;
  }
  regularization_ = nullptr;
}
inline const ::tensorflow::boosted_trees::learner::TreeRegularizationConfig& LearnerConfig::regularization() const {
  ...
  return p != nullptr ? *p : *reinterpret_cast<const ::tensorflow::boosted_trees::learner::TreeRegularizationConfig*>(
...
inline void LearnerConfig::set_allocated_regularization(::tensorflow::boosted_trees::learner::TreeRegularizationConfig* regularization) {
  ...
  if (regularization) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(regularization);
    if (message_arena != submessage_arena) {
      regularization = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
...
inline void LearnerConfig::clear_constraints() {
  if (GetArenaNoVirtual() == nullptr && constraints_ != nullptr) {
    delete constraints_;
  }
...
inline const ::tensorflow::boosted_trees::learner::TreeConstraintsConfig& LearnerConfig::constraints() const {
  ...
  return p != nullptr ? *p : *reinterpret_cast<const ::tensorflow::boosted_trees::learner::TreeConstraintsConfig*>(
...
inline void LearnerConfig::set_allocated_constraints(::tensorflow::boosted_trees::learner::TreeConstraintsConfig* constraints) {
  ...
  if (constraints) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(constraints);
    if (message_arena != submessage_arena) {
...
inline bool LearnerConfig::has_learning_rate_tuner() const {
  return this != internal_default_instance() && learning_rate_tuner_ != nullptr;
}
inline void LearnerConfig::clear_learning_rate_tuner() {
  if (GetArenaNoVirtual() == nullptr && learning_rate_tuner_ != nullptr) {
    delete learning_rate_tuner_;
  }
  learning_rate_tuner_ = nullptr;
}
inline const ::tensorflow::boosted_trees::learner::LearningRateConfig& LearnerConfig::learning_rate_tuner() const {
  ...
  return p != nullptr ? *p : *reinterpret_cast<const ::tensorflow::boosted_trees::learner::LearningRateConfig*>(
...
inline ::tensorflow::boosted_trees::learner::LearningRateConfig* LearnerConfig::mutable_learning_rate_tuner() {
  ...
  if (learning_rate_tuner_ == nullptr) {
...
inline void LearnerConfig::set_allocated_learning_rate_tuner(::tensorflow::boosted_trees::learner::LearningRateConfig* learning_rate_tuner) {
  ...
  if (learning_rate_tuner) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(learning_rate_tuner);
    if (message_arena != submessage_arena) {
      learning_rate_tuner = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
...
inline bool LearnerConfig::has_averaging_config() const {
  return this != internal_default_instance() && averaging_config_ != nullptr;
}
inline void LearnerConfig::clear_averaging_config() {
  if (GetArenaNoVirtual() == nullptr && averaging_config_ != nullptr) {
    delete averaging_config_;
  }
  averaging_config_ = nullptr;
}
inline const ::tensorflow::boosted_trees::learner::AveragingConfig& LearnerConfig::averaging_config() const {
  ...
  return p != nullptr ? *p : *reinterpret_cast<const ::tensorflow::boosted_trees::learner::AveragingConfig*>(
...
inline void LearnerConfig::set_allocated_averaging_config(::tensorflow::boosted_trees::learner::AveragingConfig* averaging_config) {
  ...
  if (averaging_config) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(averaging_config);
    if (message_arena != submessage_arena) {
      averaging_config = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
...
// .tensorflow.boosted_trees.trees.DecisionTreeConfig each_tree_start = 13;
inline bool LearnerConfig::has_each_tree_start() const {
  return this != internal_default_instance() && each_tree_start_ != nullptr;
}
inline const ::tensorflow::boosted_trees::trees::DecisionTreeConfig& LearnerConfig::each_tree_start() const {
  const ::tensorflow::boosted_trees::trees::DecisionTreeConfig* p = each_tree_start_;
  // @@protoc_insertion_point(field_get:tensorflow.boosted_trees.learner.LearnerConfig.each_tree_start)
  return p != nullptr ? *p : *reinterpret_cast<const ::tensorflow::boosted_trees::trees::DecisionTreeConfig*>(
      &::tensorflow::boosted_trees::trees::_DecisionTreeConfig_default_instance_);
}
inline ::tensorflow::boosted_trees::trees::DecisionTreeConfig* LearnerConfig::release_each_tree_start() {
  // @@protoc_insertion_point(field_release:tensorflow.boosted_trees.learner.LearnerConfig.each_tree_start)
  
  ::tensorflow::boosted_trees::trees::DecisionTreeConfig* temp = each_tree_start_;
  if (GetArenaNoVirtual() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  each_tree_start_ = nullptr;
  return temp;
}
inline ::tensorflow::boosted_trees::trees::DecisionTreeConfig* LearnerConfig::unsafe_arena_release_each_tree_start() {
  // @@protoc_insertion_point(field_unsafe_arena_release:tensorflow.boosted_trees.learner.LearnerConfig.each_tree_start)
  
  ::tensorflow::boosted_trees::trees::DecisionTreeConfig* temp = each_tree_start_;
  each_tree_start_ = nullptr;
  return temp;
}
inline ::tensorflow::boosted_trees::trees::DecisionTreeConfig* LearnerConfig::mutable_each_tree_start() {
  
  if (each_tree_start_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::boosted_trees::trees::DecisionTreeConfig>(GetArenaNoVirtual());
    each_tree_start_ = p;
  }
  // @@protoc_insertion_point(field_mutable:tensorflow.boosted_trees.learner.LearnerConfig.each_tree_start)
  return each_tree_start_;
}
inline void LearnerConfig::set_allocated_each_tree_start(::tensorflow::boosted_trees::trees::DecisionTreeConfig* each_tree_start) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(each_tree_start_);
  }
  if (each_tree_start) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(each_tree_start)->GetArena();
    if (message_arena != submessage_arena) {
      each_tree_start = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, each_tree_start, submessage_arena);
    }
    
  } else {
    
  }
  each_tree_start_ = each_tree_start;
  // @@protoc_insertion_point(field_set_allocated:tensorflow.boosted_trees.learner.LearnerConfig.each_tree_start)
}

// int32 each_tree_start_num_layers = 14;
inline void LearnerConfig::clear_each_tree_start_num_layers() {
  each_tree_start_num_layers_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 LearnerConfig::each_tree_start_num_layers() const {
  // @@protoc_insertion_point(field_get:tensorflow.boosted_trees.learner.LearnerConfig.each_tree_start_num_layers)
  return each_tree_start_num_layers_;
}
inline void LearnerConfig::set_each_tree_start_num_layers(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  each_tree_start_num_layers_ = value;
  // @@protoc_insertion_point(field_set:tensorflow.boosted_trees.learner.LearnerConfig.each_tree_start_num_layers)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_tensorflow_2fcontrib_2fboosted_5ftrees_2fproto_2flearner_2eproto
